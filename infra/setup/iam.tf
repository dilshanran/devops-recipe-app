###create IAM user and policiews fro CD account ##
...
#policy for terraform backend to access s3 bucket and dynamodb access
...
resource "aws_iam_policy" "tf_backend" {
  ...
  description = "Policy for terraform backend to access s3 bucket and dynamodb access"
